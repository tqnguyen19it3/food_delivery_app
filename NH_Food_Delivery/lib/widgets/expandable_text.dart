  ...
  Widget build(BuildContext context) {
    return Container(
      child: secondHalf.isEmpty ? SmallText(color: AppColors.paraColor, size: 16, text: firstHalf) : Column(
        children: [
          SmallText(height: 1.6, color: AppColors.paraColor, size: 16, text: hiddenText ? (firstHalf + "...") : (firstHalf + secondHalf)),
          InkWell(
            onTap: (){
              setState(() {
            ...
            child: Row(
              children: [
                hiddenText ? SmallText(text: "Show more", color: AppColors.mainColor,) : SmallText(text: "Hide away", color: AppColors.mainColor,),
