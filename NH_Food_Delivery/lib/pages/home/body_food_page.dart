...
import 'package:nh_food_delivery/widgets/icon_and_text.dart';
    ...
    return Column(
      children: [
        GetBuilder<PopularProductController>(builder: (popularProducts){
          return popularProducts.isLoaded ? Container(  //slider
        ...
        GetBuilder<PopularProductController>(builder: (popularProducts) {
          return DotsIndicator(  //thu vien dots_indicator
          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: index.isEven ? Color(0xFFffa500) : Color(0xFFbd2d3d),
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: NetworkImage(
            ...
            Align(
              ...
              child: Container(
                ...
                child: Container(
                  padding: EdgeInsets.only(top: 7, left: Dimensions.width15, right: Dimensions.width15,),
